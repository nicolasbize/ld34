...
class ApplicationMain {
	...
	public static function create ():Void {
		...
		urls.push ("assets/sprite/front-head.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/sprite/front-left-arm.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/sprite/front-left-leg.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/sprite/front-right-arm.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/sprite/power.png");
		types.push (lime.Assets.AssetType.IMAGE);
		...
		urls.push ("assets/sprite/side-left-arm.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/sprite/side-left-leg.png");
		types.push (lime.Assets.AssetType.IMAGE);
		
		
		urls.push ("assets/sprite/side-right-arm.png");
		types.push (lime.Assets.AssetType.IMAGE);
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 800, 500, "000000");
		#end
		#else
		create ();
		#end
