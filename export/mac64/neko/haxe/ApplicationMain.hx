...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "executioner", "com.example.myapp", "0.1.0");
		...
		telemetryConfig.app_name = "executioner";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "executioner", null, { width: 800, height: 500 });
			
			
			#if openfl
			var stage = wx.NMEStage.create (frame, null, null, { width: 800, height: 500 });
			#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		#if (js && html5)
		#if (munit || utest)
		openfl.Lib.embed (null, 800, 500, "null");
		#end
		#else
		create ();
		#end
