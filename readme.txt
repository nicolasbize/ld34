...
ARTWORK:
X arena background with a crowd.
- crowd, each person with clap animation
X main character with a simple walk and shoot animation
- a couple of victims with body parts

SOUND:
- lots of screaming lol

MUSIC:
- a nice soothing melody



Let's get started with the art!!
